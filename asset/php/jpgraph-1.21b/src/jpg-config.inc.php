...
if (eregi("unix",strtolower($_SERVER["SERVER_SOFTWARE"])) || eregi("linux",strtolower($_SERVER["SERVER_SOFTWARE"]))) {
	DEFINE("TTF_DIR","/home/adam/workspace/www/zdf/deployed/i-Medis/fonts/");
}
